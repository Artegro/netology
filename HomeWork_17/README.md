...
-   Были востановленны кластеры базы данных в отдельных ЦОД по очереди и возабленны репликации, дабы избежать конфликта данных. Работоспособность сервисов полностью востановлена без потерь данных.
