...
Ответ:
  ...
  Но так как мееджер хочет понимать насколько мы выполняем со свой стороны обязательства, то стоит оговорить использование подхода к мониторингу 
  SLA, SLO, SLI и использовать с менеджером уже параметро SLI для оценки качества не загужая мееджера техничискими подробностями во что менно упирается наш сервис.  
