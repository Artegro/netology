...
выведите в мониторинг и почему?
  ...
  - Мониторинг сети -  подключение, его скорость и его утилизацию
...
можете ему предложить?
  ...
  Ответ:
  - Объяснить менеджеру понятия  RAM/inodes/CPUla = Оперативная память / Загруженность файловой системы / Средняя нагрузка на процессор. 
  - Но так как менеджер хочет понимать насколько мы выполняем со свой стороны обязательства, то стоит оговорить использование подхода (SLO, SLA, SLI).
  - Установить договором параметры желаемоно обслуживания SLA и использовать для анализа качества обслуживания уже параметр SLI, не загужая менеджера техничискими подробностями по загрузке (RAM/inodes/CPUla).
  
  П.С. По скольку нет данных никаких что это за проект-приложение-сервис ... какие метрики для анализа работы я могу выбрать... 
  Давайте представим что речь идет про веб сервис , тогда нам для оценки качество работы надо будет взять соотношение колличества 200-х и 300-х ответов сервиса к колличеству 400-х и 500-х например. Или давай те оценивать по пингам с сервера адреса 8.8.8.8 например доступность сервиса, сколько процентов пакетов выпадает так хорошо мы и делаем работу...
  Но мы сейчас обсуждаем "сферического коня в вакуоме".
